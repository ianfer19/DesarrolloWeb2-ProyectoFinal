...
@Component({
  selector: 'app-cocina2',
  templateUrl: './cocina2.component.html',
  styleUrls: ['./cocina2.component.css']
})
export class Cocina2Component implements OnInit{
    ...
    leerPedidos() {
      this.pedidoService.getPedidoPorProductoPedido().subscribe(
        (data) => {
          this.pedidos = data;
          console.log(data)
